...
void mipsFPGA_net_input(struct netif *netif);
...
void vBasicWEBServer( void *pvParameters )
{
	...
	MIPSFPGA_ETH_T *eth = web_info->eth;
	MIPSFPGA_UART_T *uart = web_info->uart;
	...
	netif_set_hostname(&nif, "mipsFPGA_demo");
	dhcp_start( &nif );
