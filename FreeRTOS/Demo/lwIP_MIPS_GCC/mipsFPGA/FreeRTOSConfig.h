...
#define configTICK_RATE_HZ                          ( ( TickType_t ) configCPU_CLOCK_HZ / 2 )
...
//#define traceTASK_SWITCHED_OUT() do { uartTxDirect(pxCurrentTCB->pcTaskName); uartTxDirect("--->\r\n"); } while(0)
//#define traceTASK_SWITCHED_IN() do { uartTxDirect("--->"); uartTxDirect(pxCurrentTCB->pcTaskName); uartTxDirect("\r\n"); } while(0)
